 ...
 * @since krds 1.0
 */
function krds_scripts() {

	// Theme stylesheet.
	wp_enqueue_style( 'krds-style', get_stylesheet_uri(), [], VERSION );

	// Load the html5 shiv.
	wp_enqueue_script( 'krds-html5', get_template_directory_uri() . 'assets/js/html5.js', array(), '3.7.3' );
	wp_script_add_data( 'krds-html5', 'conditional', 'lt IE 9' );
...
add_action( 'wp_enqueue_scripts', 'krds_scripts' );
